...
public class Prueba {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("7. Mostrar recaudos de la red");
            ...
            switch (opcion) {
                ...
                case 4: // ingresar un vehiculo a algun garaje
                    try {
                        ...
                        if (garaje == null) {
                            throw new ExcepcionGarajeNoEncontrado("No se encontró ningún garaje en la dirección: " + direccionGaraje);
                        }
                    ...
                    } catch (ExcepcionGarajeNoEncontrado e) {
                ...
                case 6: // para generar los informes
                    ...
                    switch (informeOpcion) {
                        ...
                        case 2 -> {
                            System.out.print("Tipo de vehículo (Auto, Moto, Camion): ");
                            String tipoVehiculo = scanner.nextLine();
                            red.mostrarOcupacionPorTipoVehiculo(tipoVehiculo);
                        }
